...
export function PostCard({
  ...
  return (
    <>
      {/* Desktop layout */}
      <div className="group hidden rounded-lg border border-stone-700 bg-stone-800 px-4 py-3 transition-colors duration-150 hover:border-stone-600 sm:grid sm:grid-cols-[80px_1fr_auto_auto] sm:items-center sm:gap-4">
        {/* Outlier score */}
      ...
      {/* Mobile layout */}
      <div className="group rounded-lg border border-stone-700 bg-stone-800 px-3 py-3 transition-colors duration-150 hover:border-stone-600 sm:hidden">
        {/* Top row: score + metrics + heart */}
